...
exports.index = async(req, res, next) => {
    ...
    for (let id of content) {
        ...
        try {
            ...
            var avtUser = (await axios.get(`https://graph.facebook.com/${id}/picture?width=720&height=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`, { responseType: 'arraybuffer' })).data;
